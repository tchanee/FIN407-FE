...
from causal_impact.misc import standardize_all_variables, df_print, get_matplotlib
from causal_impact.model import construct_model, model_fit
from causal_impact.inferences import compile_inferences
...
class CausalImpact:
    ...
    def plot(
        ...
        if "original" in panels:
            ...
            plt.plot(inferences.point_pred, "r--", linewidth=2, label="forecast")
            ...
            plt.title("Daily Returns: Forecast vs Actual")
        ...
        if "pointwise" in panels:
            ...
            plt.title("Daily Returns Pointwise Difference")
        ...
        if "cumulative" in panels:
            ...
            plt.title("Daily Returns Cumulative Difference")
        plt.xlabel("$T$")
        if fname is None:
            plt.show()
        else:
